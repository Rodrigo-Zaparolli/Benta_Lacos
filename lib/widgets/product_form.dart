...
class _ProductFormState extends State<ProductForm> {
  ...
  late TextEditingController _quantidadeController; // Adicionado
  late TextEditingController _corController;
  late TextEditingController _compositionController;
  late TextEditingController _descricaoController;
  late TextEditingController _imageUrlController;
  late TextEditingController _gallery1Controller;
  late TextEditingController _gallery2Controller;
  late TextEditingController _gallery3Controller;
  ...
  void initState() {
    ...
    // Inicializa a quantidade (puxa do Firebase ou começa em 0)
    ...
    _gallery1Controller = TextEditingController(
      text: (p?.galleryUrls != null && p!.galleryUrls!.isNotEmpty)
          ? p.galleryUrls![0]
          : '',
    );
    _gallery2Controller = TextEditingController(
      text: (p?.galleryUrls != null && p!.galleryUrls!.length > 1)
          ? p.galleryUrls![1]
          : '',
    );
    _gallery3Controller = TextEditingController(
      text: (p?.galleryUrls != null && p!.galleryUrls!.length > 2)
          ? p.galleryUrls![2]
          : '',
    );
  ...
  void dispose() {
    ...
    _quantidadeController.dispose(); // Adicionado
    _corController.dispose();
    _compositionController.dispose();
    _descricaoController.dispose();
    _imageUrlController.dispose();
    _gallery1Controller.dispose();
    _gallery2Controller.dispose();
    _gallery3Controller.dispose();
    super.dispose();
  }
  ...
  Future<void> _handleSave() async {
    ...
    try {
      ...
      final List<String> galeria = [
        _gallery1Controller.text.trim(),
        _gallery2Controller.text.trim(),
        _gallery3Controller.text.trim(),
      ...
      final product = Product(
        ...
        quantity: quantidadeConvertida, // Adicionado ao objeto Product
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // SEÇÃO DE PREÇO E QUANTIDADE EM LINHA
              Row(
                children: [
                  Expanded(
                    flex: 2,
                  ...
                  Expanded(
                    ...
                    child: _buildTextField(
                      ...
                      isOnlyNumbers:
                          true, // Campo específico para números inteiros
                    ),
                  ),
                ],
              ),

              _buildDropdownField(), // Categoria agora em linha cheia para melhor visual
